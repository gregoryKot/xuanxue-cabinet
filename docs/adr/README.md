...
| [0117](0117-link-preview-and-full-bleed-ios-icon.md)             | Превью ссылки в мессенджере и ярлык iOS во всю плитку — из одного знака (ADR-0085)              |
...
| [0120](0120-tasks-are-split-by-what-waits-for-the-student.md)    | Задания делятся на «Сдавать сейчас» и «Уже позади»; на карточке сначала настоящее               |
| [0121](0121-exam-start-asks-before-the-clock-starts.md)          | Дедлайн остаётся абсолютным: вопрос перед стартом, идущий экзамен виден в списке и в боте       |
...
| [0123](0123-submitted-work-can-be-reread.md)                     | Сданную работу ученик может перечитать, но не изменить; итог остаётся только на карточке        |
| [0124](0124-accent-is-bold-on-the-fact.md)                       | Акцент в тексте — полужирный на факте, маркер `**…**`, гейт на плоский абзац                    |
| [0125](0125-exam-due-date-is-a-second-independent-limit.md)      | Срок сдачи — второе поле рядом с лимитом времени; прошедший срок закрывает только новые попытки |
| [0126](0126-attempt-screen-reads-one-attempt.md)                 | Экран сдачи читает одну попытку своим адресом (`GET /attempts/:id`), не список целиком          |
| [0127](0127-exam-due-date-in-bot-is-a-preset.md)                 | Срок сдачи в боте — пресет кнопкой (неделя/две/месяц), конец дня по часам школы                 |
