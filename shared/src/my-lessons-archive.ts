...
export interface MyArchivedLessonDto {
   ...
   * того же самого не заводим, значит и правило видимости (ADR-0058) здесь
   * действует то же — служебный материал (`access: 'staff'`) сюда ученику не
   * попадает вовсе. Пустой массив — у даты материалов нет, экран тогда не
