...
// Попытка сдачи экзамена — статусы, DTO снимка, лимиты и сообщения об
// ошибках — живут в exam-attempts.ts (`/exams/:id/attempts`, `/attempts`,
// слой 4.4): тот же предел размера файла, что увёл my-exams.ts из этого
// файла (см. шапку my-exams.ts).
