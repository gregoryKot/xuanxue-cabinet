...
// школы (черепаха, XUANXUE, 玄学; docs/adr/0084): это живопись по ткани, а не
 ...
 * оболочка отставала от палитры два месяца (docs/adr/0084). Совпадение с
...
// Бейслайн — то, за чем следит check-pwa.mjs (docs/adr/0084): sha источника
