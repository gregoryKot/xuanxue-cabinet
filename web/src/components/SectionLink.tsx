...
// (exams/ExamsSectionStats.tsx) и «Рассылок»
// (broadcasts/BroadcastsSectionLinks.tsx) — CLAUDE.md «Одна механика — один
// компонент»: оба раздела открывают подэкран одним и тем же жестом, вторая
// реализация той же карточки разошлась бы в вёрстке и попалась бы jscpd.
//
