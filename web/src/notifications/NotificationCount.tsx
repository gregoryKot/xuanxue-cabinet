// Пилюля-счётчик у значка уведомлений (ADR-0063) — общая для телефона
// (NotificationBell.tsx) и монитора (NotificationsNavLink.tsx): раздельные
// копии одного числа — дубль, который поймал бы jscpd (CLAUDE.md «Одна
