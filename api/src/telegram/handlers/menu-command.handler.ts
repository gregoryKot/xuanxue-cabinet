...
// Доступ — тот же, что у /тема: личный чат подключённого учителя, помощника
// или админа (private-teacher-chat.ts). Незнакомцу и ученику отвечает
// StartHandler своим текстом — сюда они не доходят. («/уведомления» сюда не
// относится с ADR-0065 — доступна и ученику, гейт другой.)
