...
// запросе и тиком раз в минуту (ADR-0120). Значит ученик обязан видеть
...
// `timeLimitMin` — продолжительность одной попытки, и всё, что здесь
// считается, считается от неё. Появится срок — это отдельное решение.
//
