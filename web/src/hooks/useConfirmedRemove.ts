...
// вопросе банка срабатывало с одного касания без подтверждения и отмены — на
// телефоне рядом с ней другие кнопки (аудит 2026-09-15, важно №2). Вынесено
// из формы канала (там та же связка confirming/removed+эффект была написана
// вручную): вторая и третья копии одного и того же — сюда, а не по файлам
