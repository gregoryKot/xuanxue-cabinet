 ...
 *
 * Вложенный лист (например ConfirmDialog поверх ChannelSheet) при монтировании
 ...
 *
 * Правило для вложенного диалога (ConfirmDialog поверх страницы-редактора):
 * лист закрывается только через собственный
 ...
 * п.5, п.18, пример — hooks/useConfirmedRemove.ts). Два navigate(-1) в одном
