...
// «после оплаты» решает рубильник школы на экране «Материалы»
...
const HINTS: Partial<Record<MaterialAccess, string>> = {
  paid: 'Сработает, когда на «Материалах» включат доступ по оплате. Пока он выключен, материал видят все.',
