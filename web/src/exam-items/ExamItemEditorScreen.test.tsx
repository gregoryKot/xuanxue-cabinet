...
// Черновик (ADR-0046) пишется в реальный localStorage — очищаем между
...
describe('ExamItemEditorScreen — черновик (ADR-0046)', () => {
  ...
  it('ушли со страницы с набранным и вернулись — черновик на месте', async () => {
    ...
    // компонента формы из дерева (ровно это стирало состояние до ADR-0046).
    first.unmount();
