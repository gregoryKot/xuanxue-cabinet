...
describe('USER_STATUSES', () => {
  it('только active и blocked — статуса invited больше нет (ADR-0034, инцидент 2026-09-15)', () => {
  ...
  it('тип UserStatus не пропускает invited — расхождение с контрактом /auth/me ловит tsc', () => {
    // @ts-expect-error — статуса invited больше нет (ADR-0034, инцидент 2026-09-15)
