...
export const EXAM_ITEM_KIND_HINTS_RU: Record<ExamItemKind, string> = {
  text: 'Ученик пишет ответ словами — читаете и оцениваете вы.',
  single: 'Ученик отмечает один вариант — ответ сверяется сам.',
  multiple: 'Ученик отмечает все верные варианты — ответ сверяется сам.',
  video: 'Ученик присылает запись — смотрите и оцениваете вы.',
};
