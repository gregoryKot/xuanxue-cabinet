 ...
 * `<button>`, а просто строка. Отступы и карточка — те же, что у нажимаемой
 * строки ниже: список должен читаться одним ритмом. Промежуток между
 * карточками задаёт `gap` контейнера-списка, не отступы самой строки. */
