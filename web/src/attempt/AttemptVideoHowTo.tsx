...
const YOUTUBE =
  'YouTube. Загрузите запись и в настройках доступа выберите «Доступ по ссылке». «Ограниченный доступ» не подойдёт: по нему учитель видео не откроет. Ссылку возьмите в «Поделиться».';
const VK =
  'ВКонтакте. Загрузите видео в «Мои видео», в приватности поставьте «Доступ по ссылке» или «Все пользователи», скопируйте ссылку.';
const OTHER =
  'Rutube, Яндекс.Диск, Облако Mail.ru годятся так же. Важно одно: видео открывается по ссылке, без входа в чужой аккаунт.';
const MISTAKE =
  'Частая ошибка — приватная запись. Учитель увидит её закрытой и сам об этом не напишет: узнает, только когда откроет ссылку. Проверьте свою ссылку в окне, где вы не вошли в свой аккаунт.';
