...
// VOICE: коротко, на «вы», что делать — заголовок уже сказал, что случилось,
// повторять незачем. Назначить вопрос такой записи на экране нельзя — значит
// и не обещаем: действие здесь одно, посмотреть и учесть при оценке.
const ORPHAN_MEDIA_EXPLANATION =
  'Так бывает со ссылками, **отправленными раньше**. Посмотрите и учтите её при оценке.';
