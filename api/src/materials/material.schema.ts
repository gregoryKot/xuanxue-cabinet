// Материал библиотеки школы (слой 3.1, docs/PLAN.md §14, ADR-0047) — данные
// школы, не ученика: список общий для всего штата, как заготовки
// комментариев (grading-comment-preset.schema.ts). `title`/`url` —
