// Строка формы в списке — название, служебная строка метаданных, статус
...
// (ExamItemCard.tsx). Уровень формы в строке не показан — редактируется на
// листе, а в списке места на него у макета не нашлось (Main.dc.html).
