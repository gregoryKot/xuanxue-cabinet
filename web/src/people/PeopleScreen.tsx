...
// (ADR-0030/0035), и назначение ролей учитель/админ (docs/PLAN.md §6,
...
// (ADR-0035), единственный акцент экрана — ссылка-приглашение.
...
// После ADR-0035 вход без ссылки-приглашения получает 403 — текст ведёт к
