...
// docs/PLAN.md §14, ADR-0047). Без @Roles: доступно любой вошедшей роли,
// включая ученика и гостя без единой роли — тот же приём, что у
...
// не публичный. Штат школы (isStaffRole) видит и служебные материалы
// (`access: 'staff'`) как обычные — ADR-0058 закрывает их только ученику.
