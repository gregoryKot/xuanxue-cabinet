...
// `(attemptId, itemId)`): ссылка на ВОПРОС — одна, но с ADR-0084 индекс не
...
// ADR-0084: работу уже проверили — молча подменять оценённый ответ нельзя,
...
// ADR-0084: гонка двух параллельных upsert на один (attemptId, itemId) —
