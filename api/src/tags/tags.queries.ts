// Агрегации для сводки тегов школы (GET /api/tags, ADR-0075, ADR-0076) — две
// независимые агрегации по двум коллекциям, без денормализации (ADR-0075
 ...
 * (ADR-0076). `classModel.collection.name`, не строка `'classes'`: имя
 ...
 * (ADR-0075), и лимит должен резать самые редкие теги, а не произвольные по
 * алфавиту (ADR-0076 «число у тега считается тем же правилом, что и
