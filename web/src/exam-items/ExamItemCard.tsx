...
// <button>, не <div onClick> (CLAUDE.md «Доступность»), стиль — общий
// components/listCardStyles.ts. Статистика (ТЗ 4.8) живёт на странице
// вопроса разделом «Как отвечают», не кнопкой внутри строки: числа не нужны
// при каждом взгляде на список, а вторая кнопка в строке ломала её как
// список (ADR-0033, макет Main.dc.html).
