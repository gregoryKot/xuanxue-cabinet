...
const STRANGER_MESSAGE_BASE =
  'Это бот школы Сюань-Сюэ, для её учеников: он присылает ссылки на занятия ' +
  'и принимает экзамены. Вас он пока не узнаёт. Уже занимаетесь — откройте ' +
  'кабинет, зайдите в «Профиль» и нажмите «Связать Telegram».';
const MENU_TEXT =
