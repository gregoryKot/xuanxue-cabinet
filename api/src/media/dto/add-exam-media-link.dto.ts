...
// `itemId` (ADR-0037) — экран сдачи присылает его всегда; необязательным поле
// остаётся только ради деплоя (expand → contract: старый инстанс ещё пишет
// без него). Сервис проверяет, что это video-вопрос снимка.
